$(document).ready(function() {
    $(window).scroll(function(event){
        ...
        let h=$('.contet').outerHeight();       //content height
        let h_b=$('.parallax').outerHeight();   //height of upper block
        let p = s/h*100;                        //percentage
        let p_b = s/h_b*100;                    //percentage of upper block
        let o = 1-1/100*p_b;                    //opacity

        let z_1 = 1+(w/10000*p_b);              //zoom
